...
class Controller_inscription extends Controller
{
	...
	public function action_creation_p() {
		...
		if (isset($_POST["nom"]) && trim($_POST["nom"]) !== "" && isset($_POST["nb"]) && trim($_POST["nb"]) !== "" && isset($_POST["niveau"]) && trim($_POST["niveau"]) !== "" && isset($_POST["ville"]) && trim($_POST["ville"]) !== "" && isset($_POST["etablissement"]) && trim($_POST["etablissement"]) !== "" && isset($_POST["prenom"]) && trim($_POST["prenom"]) !== "" && isset($_POST["adr"]) && trim($_POST["adr"]) !== "" && preg_match("/^[_a-zA-Z0-9-]+(\.[_a-zA-Z0-9-]+)*@([a-zA-Z0-9-]+\.)+[a-zA-Z]{2,4}$/", $_POST["adr"]) && isset($_POST["mdp"]) && trim($_POST["mdp"]) !== ""){
			$liste = ['nom', 'prenom', 'adr', 'mdp', 'etablissement', 'ville', 'niveau', 'nb'];
